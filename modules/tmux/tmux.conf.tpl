...
# Right status bar
set -g status-right "#(~/bin/battery Discharging; ~/bin/battery Charging) | %a %e %b %R (UTC%z)"
...
%%ifeq OS linux
bind-key -T copy-mode-vi Enter send-keys -X copy-pipe-and-cancel "xsel -i -p -b"
%%endif
